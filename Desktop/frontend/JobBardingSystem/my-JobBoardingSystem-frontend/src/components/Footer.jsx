        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/resources/resume" className="text-gray-300 hover:text-white">
                  Resume Tips
                </Link>
              </li>
              <li>
                <Link to="/resources/interview" className="text-gray-300 hover:text-white">
                  Interview Prep
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/resources/hiring" className="text-gray-300 hover:text-white">
                  Hiring Resources
                </Link>
              </li>
              <li>
                <Link to="/contact-sales" className="text-gray-300 hover:text-white">
                  Contact Sales
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex">
                ...
                />
                <button className="bg-teal-600 hover:bg-teal-700 px-4 py-2 rounded-r-md">Subscribe</button>
              </div>
            </div>
          </div>
        </div>
